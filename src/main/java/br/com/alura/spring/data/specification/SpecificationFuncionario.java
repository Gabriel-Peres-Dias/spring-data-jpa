...
public class SpecificationFuncionario {
    ...
    public static Specification<Funcionario> dataDeContratacao(LocalDate dataContratacao) {
        return (root, criteriaQuery, criteriaBuilder) -> criteriaBuilder.greaterThan(root.get("nome"),dataContratacao);
    }
}
